...
% distribution reproduction and load on spine links
% TCP vs UDP with 1 priority queue
% Spatial diversity problem of priority "inversion"
% SD with bigger topology 
...
%\subsubsection{Performance with spatial diversity}