\chapter{Reducing Flow Completion Time}
...
\section{State-of-the-art implementations}
...
\begin{subsection}{PIAS: reference size-agnostic architecture}
	\label{sec:pias}
...
\[
f_i(x) = \frac{f(x)}{\bar{F}(\alpha_{i-1})}
\]
It holds:
\begin{equation}
