...
% FIFO wins over PS (with ES-N it is not convenient to do FIFO)

% In other words, the flow size distributions fed in low priority servers have reduced variability (Fig. \ref{fig:cdfs}). This is a clear downside for PS policy.
\begin{figure}
	\centering
...
\end{figure}%
Additionally, FIFO does not suffer flow synchronization problem.
\begin{figure}
	\centering
	\captionsetup{width=.8\linewidth}
